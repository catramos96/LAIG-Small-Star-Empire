...
winner(Board,P1,P2):- 	playerGetPoints(Board,P1,ListLength1,Points1),	
						...
						/*more 3 points for the player with the biggest territory*/
						chooseWinner(Board,P1,NewPoints1,P2,NewPoints2,winner) .	%compares the points
...
*/																				
chooseWinner(Board,_,Points,_,Points,'None')	:-	displayBoard(Board),nl,write('DRAW!').	
chooseWinner(Board,P1,Points1,_,Points2,'Player 1') :- Points1 > Points2, displayWinner(Board,P1,Points1,Points2).
chooseWinner(Board,_,Points1,P2,Points2,'Player 2') :- Points1 < Points2, displayWinner(Board,P2,Points1,Points2).
